## Table of contents
1. [Introduction](rnaseq_tutorial#introduction)
  1. [Description of the lab](rnaseq_tutorial#description-of-the-lab)
  2. [Requirements](rnaseq_tutorial#requirements)
  3. [Compatibility](rnaseq_tutorial#compatibility)
  4. [Data Set for IGV](rnaseq_tutorial#compatibility)
2. [Visualization Part 1: Getting familiar with IGV](rnaseq_tutorial#visualization-part-1-getting-familiar-with-igv)
  1. [Get familiar with the interface](rnaseq_tutorial#get-familiar-with-the-interface)
    1. [Load a Genome and Data Tracks](rnaseq_tutorial#load-a-genome-and-some-data-tracks)
    2. [Navigation](rnaseq_tutorial#navigation)
  2. [Region Lists](rnaseq_tutorial#region-lists)
  3. [Loading Read Alignments](rnaseq_tutorial#loading-read-alignments)
  4. [Visualizing read alignments](rnaseq_tutorial#visualizing-read-alignments)
3. [Visualization Part 2: Inspecting SNPs, SNVs, and SVs](rnaseq_tutorial#visualization-part-2-inspecting-snps-snvs-and-svs-)
  1. [Neighbouring somatic SNV and germline SNP](rnaseq_tutorial#neighbouring-somatic-snv-and-germline-snp)
  2. [Homopolymer repeat with indel](rnaseq_tutorial#homopolymer-repeat-with-indel)
  3. [Coverage by GC](rnaseq_tutorial#coverage-by-gc)
  4. [Heterozygous SNPs on different alleles](rnaseq_tutorial#heterozygous-snps-on-different-alleles)
  5. [Low mapping quality](rnaseq_tutorial#low-mapping-quality)
  6. [Homozygous deletion](rnaseq_tutorial#homozygous-deletion)
  7. [Mis-alignment](rnaseq_tutorial#mis-alignment)
  8. [Translocation](rnaseq_tutorial#translocation)
4. [Visualization Part 3: Automating Tasks in IGV](rnaseq_tutorial#visualization-part-3-automating-tasks-in-igv)
